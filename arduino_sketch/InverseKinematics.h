...
namespace ModularBiped {
    ...
    */ 
    class InverseKinematics
    {
        // constructor
        public:
            double hipAdjustment = Config::HIP_ADJUSTMENT; // Angle to adjust hip, will be modified for balance
            ...
            */
            boolean inverseKinematics2D(float x, float y, float &hipAngle, float &kneeAngle, float &ankleAngle)
            {
                ...
                kneeAngle = r2d(knee - d2r(Config::KNEE_ADJUSTMENT)); // Offset 90 to compensate
                ankleAngle = r2d(ankle + d2r(Config::ANKLE_ADJUSTMENT)); // Offset 70 to compensate
